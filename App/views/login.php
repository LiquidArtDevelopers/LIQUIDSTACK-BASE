        ...
        <div id="smooth-content">
            <main>
                <video data-lang="video" id="video" width="100%" height="100%" preload="auto" autoplay loop muted playsinline title="<?= $video->title ?>">
                    <source src="<?= $_ENV["RAIZ"] ?>/assets/video/club-atletico-san-sebasdtian-socios.webm" type="video/webm">
                    <source src="<?= $_ENV["RAIZ"] ?>/assets/video/club-atletico-san-sebasdtian-socios.mp4" type="video/mp4">
                </video>
